...
# O Render costuma fornecer variaveis como apenas um numero ("10").
# O SlowAPI espera formato tipo "10/minute" ou "10 per minute".
def _normalize_rate_limit(value: str | None, default: str) -> str:
    if value is None:
        return default
...
DEFAULT_RATE_LIMIT = _normalize_rate_limit(os.getenv("RATE_LIMIT_DEFAULT"), "60/minute")
PREDICT_RATE_LIMIT = _normalize_rate_limit(os.getenv("RATE_LIMIT_PREDICT"), "30/minute")
BATCH_RATE_LIMIT = _normalize_rate_limit(os.getenv("RATE_LIMIT_BATCH"), "10/minute")
LOGIN_RATE_LIMIT = _normalize_rate_limit(os.getenv("RATE_LIMIT_LOGIN"), "10/minute")
